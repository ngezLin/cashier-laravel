...
<div class="container mt-4">
    ...
    <form action="{{ route('cashier.products.update', $product->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" name="sell_price" value="{{ old('sell_price', $product->sell_price) }}" required>
        </div>
        <div class="mb-3">
            <label for="buy_price" class="form-label">Harga Beli</label>
            <input type="number" class="form-control" name="buy_price" value="{{ old('buy_price', $product->buy_price) }}" required>
        </div>
        <div class="mb-3">
